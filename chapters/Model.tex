...
\section{Concept} \label{sec:concept_Model}
  ...
  \begin{figure}[!htpb]
    \centering
    \includegraphics[width=0.5 \textwidth]{model/exampleBuckling}
...
\section{Computational model} \label{sec:computationalModel}
  ...
  \subsection{Parametric study method} \label{subsec:parametricStudy_computationalModel}
    ...
    An schematic characterization of the program execution is shown the flow chart represented in Figure \ref{fig:flowChart}. The code written for this program can be found in Appendix \label{appen:code}. 
