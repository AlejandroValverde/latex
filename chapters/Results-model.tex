...
\section{Analytical model analysis} \label{sec:analyticalParametricStudy_results_model}
  ...
  \subsection{Bending and twisting coupling results and discussion} \label{subsec:bendingTwistCoupling_results_model}
    ...
    \begin{figure}[!htpb] %twist and bend versus E1/E2
      \centering
      \includegraphics[width=0.8 \textwidth]{figures/../../analytical/figures/twist-E1overE2}
  ...
  \subsection{Parametric study results and discussion} \label{subsec:results_parametricStudy}
    ...
    \begin{figure}[!htpb] %G I_t versus B/H
      \centering
      \includegraphics[width=0.8 \textwidth]{figures/../../analytical/figures/GIt-E1overE2-BoverH}
    ...
    \begin{figure}[!htpb] %Shear centre versus B/H
      \centering
      \includegraphics[width=0.8 \textwidth]{figures/../../analytical/figures/SC-E1overE2-BoverH}
    ...
    \begin{figure}[!htpb] %E I_y = \Phi_y versus B/H
      \centering
      \includegraphics[width=0.8 \textwidth]{figures/../../analytical/figures/EIy-E1overE2-BoverH}
    ...
    \begin{figure}[!htpb] %G I_t versus t2/t1
      \centering
      \includegraphics[width=0.8 \textwidth]{figures/../../analytical/figures/GIt-E1overE2-t2overt1}
    ...
    \begin{figure}[!htpb] %Shear centre versus t2/t1
      \centering
      \includegraphics[width=0.8 \textwidth]{figures/../../analytical/figures/SC-E1overE2-t2overt1}
    ...
    \begin{figure}[!htpb] %E I_y = \Phi_y versus t2/t1
      \centering
      \includegraphics[width=0.8 \textwidth]{figures/../../analytical/figures/EIy-E1overE2-t2overt1}
    ...
    \begin{figure}[!htpb] %w_0,tip / Q versus B/H, flexural compliance
      \centering
      \includegraphics[width=0.8 \textwidth]{figures/../../analytical/figures/woverQ-E1overE2-BoverH}
    ...
    \begin{figure}[!htpb] %\phi_tip / Q versus B/H, torsional compliance
      \centering
      \includegraphics[width=0.8 \textwidth]{figures/../../analytical/figures/phioverQ-E1overE2-BoverH}
    ...
    \begin{figure}[!htpb] %w_0,tip / Q versus t2/t1, flexural compliance
      \centering
      \includegraphics[width=0.8 \textwidth]{figures/../../analytical/figures/woverQ-E1overE2-t2overt1}
    ...
    \begin{figure}[!htpb] %\phi_tip / Q versus t2/t1, torsional compliance
      \centering
      \includegraphics[width=0.8 \textwidth]{figures/../../analytical/figures/phioverQ-E1overE2-t2overt1}
    ...
    \begin{figure}[!htpb] %w_0,tip / Q versus L/B, flexural compliance
      \centering
      \includegraphics[width=0.8 \textwidth]{figures/../../analytical/figures/woverQ-E1overE2-LoverB}
    ...
    \begin{figure}[!htpb] %\phi_tip / Q versus L/B, torsional compliance
      \centering
      \includegraphics[width=0.8 \textwidth]{figures/../../analytical/figures/phioverQ-E1overE2-LoverB}
...
\section{Computational model analysis} \label{sec:computationalModelAnalysis_results_model}
  ...
  In the present section, results from the analysis performed on the computational model are presented. Different aspects of the model are evaluated and design decisions are justified. The analysis is going to consider the modeling of the lattice nodes rigid behavior, the different load introduction strategies, the influence of the mesh in the simulation convergence, the ribs addition and the nonlinearities that appear in the problem.

  For the proposed technology, it is expected to see the appearance of large deformations and elastic instabilities in the structure. This means that the structural stiffness of the model is going to be altered as the load applied increases. For this reason, it becomes necessary to execute nonlinear simulations in which the load applied is increased by small step increments. Each of these steps constitute a different frame that contains particular magnitudes values for each of the mesh nodes and elements.
  ...
  \subsection{Rigid body modeling} \label{subsec:rigidBody_results_model} %To be reviewed
    ...
    Two different approaches are followed to model the rigid body behavior of the lattice nodes, as it been already explained in Subsection \ref{subsec:latticeNodesRigid_Parametrization}. The first modeling approach considers the creation of a coupling condition between a reference point positioned at the centre of the lattice node cylinder and mesh nodes located in the faces of the lattice node. The second approach consists on the introduction of an additional part that is placed in the middle of the cylinder to add stiffness to the element. In this section, the results obtained for each modeling approach are compared.
  ...
  \subsection{Load introduction method} \label{subsec:load_results_model}
    ...
    \begin{figure}[!htpb]
      \centering
      \includegraphics[width=0.8 \textwidth]{figures/../figures/result-model/distributedLoad700N}
    ...
    \begin{figure}[!htpb]
      \centering
      \includegraphics[width=0.8 \textwidth]{figures/../figures/result-model/forceDisplacement-loadZ0coma8}
  ...
  \subsection{Mesh} \label{subsec:mesh_results_model}
    ...
    This type of element is a 2D element that it was used to build 3D structures. This kind of procedure may incur in distortions in the mesh elements due to shell elements intersecting in the same line at different angles.
  ...
  \subsection{Nonlinear problem and automatic stabilization} \label{subsec:nonlinear_results_model} %OK
    ...
    \begin{figure}[!htpb]
      \centering
      \includegraphics[width=0.8 \textwidth]{figures/../figures/result-model/forceDisplacement-damp}
    ...
    \begin{figure}[!htpb]
      \centering
      \includegraphics[width=0.8 \textwidth]{figures/../figures/result-model/energy_damp-5}
    ...
    \begin{figure}[!htpb]
      \centering
      \includegraphics[width=0.8 \textwidth]{figures/../figures/result-model/energy_damp-8}
    ...
    \begin{figure}[!htpb]
      \centering
      \includegraphics[width=0.8 \textwidth]{figures/../figures/result-model/energy_damp-9}
  ...
  \subsection{Ribs} \label{subsec:ribs_results_model}
    ...
    \begin{figure}[!htpb]
      \centering
      \includegraphics[width=0.8 \textwidth]{figures/../figures/result-model/closeOfRib-800N}
    ...
    \begin{figure}[!htpb]
      \centering
      \includegraphics[width=0.8 \textwidth]{figures/../figures/result-model/normalCaseNoDampNoInnerRibs_800N}
    ...
    \begin{figure}[!htpb]
      \centering
      \includegraphics[width=0.8 \textwidth]{figures/../figures/result-model/normalCaseDampNoInnerRibs}
    ...
    \begin{figure}[!htpb]
      \centering
      \includegraphics[width=0.8 \textwidth]{figures/../figures/result-model/normalCaseNoDamp2InnerRibs_800N}
