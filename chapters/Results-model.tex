...
\section{Introduction} \label{sec:intro_Results_sim}
  ...
  In the present chapter the general characterization of the model is presented. In the first section an analysis of the results obtained from the parametric study performed on the analytical model is introduced. This will provide insight of how the different design parameters affect the final mechanical properties of the beam.
