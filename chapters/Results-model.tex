\chapter{Wing-box model analysis} \label{chap:Results_model}
%
% Overview:
...
\section{Analytical model analysis} \label{sec:analyticalParametricStudy_results_model}
  ...
  \subsection{Bending and twisting coupling results and discussion} \label{subsec:bendingTwistCoupling_results_model}
    ...
    \begin{figure}[!htpb] %twist and bend versus E1/E2
      \centering
      \includegraphics[width=0.8 \textwidth]{figures/analytical/twist-E1overE2}
  ...
  \subsection{Parametric study results and discussion} \label{subsec:results_parametricStudy}
    ...
    \begin{figure}[!htpb] %G I_t versus B/H
      \centering
      \includegraphics[width=0.8 \textwidth]{figures/analytical/GIt-E1overE2-BoverH}
    ...
    \begin{figure}[!htpb] %Shear centre versus B/H
      \centering
      \includegraphics[width=0.8 \textwidth]{figures/analytical/SC-E1overE2-BoverH}
    ...
    \begin{figure}[!htpb] %E I_y = \Phi_y versus B/H
      \centering
      \includegraphics[width=0.8 \textwidth]{figures/analytical/EIy-E1overE2-BoverH}
    ...
    \begin{figure}[!htpb] %G I_t versus t2/t1
      \centering
      \includegraphics[width=0.8 \textwidth]{figures/analytical/GIt-E1overE2-t2overt1}
    ...
    \begin{figure}[!htpb] %Shear centre versus t2/t1
      \centering
      \includegraphics[width=0.8 \textwidth]{figures/analytical/SC-E1overE2-t2overt1}
    ...
    \begin{figure}[!htpb] %E I_y = \Phi_y versus t2/t1
      \centering
      \includegraphics[width=0.8 \textwidth]{figures/analytical/EIy-E1overE2-t2overt1}
    ...
    \begin{figure}[!htpb] %w_0,tip / Q versus B/H, flexural compliance
      \centering
      \includegraphics[width=0.8 \textwidth]{figures/analytical/woverQ-E1overE2-BoverH}
    ...
    \begin{figure}[!htpb] %\phi_tip / Q versus B/H, torsional compliance
      \centering
      \includegraphics[width=0.8 \textwidth]{figures/analytical/phioverQ-E1overE2-BoverH}
    ...
    \begin{figure}[!htpb] %w_0,tip / Q versus t2/t1, flexural compliance
      \centering
      \includegraphics[width=0.8 \textwidth]{figures/analytical/woverQ-E1overE2-t2overt1}
    ...
    \begin{figure}[!htpb] %\phi_tip / Q versus t2/t1, torsional compliance
      \centering
      \includegraphics[width=0.8 \textwidth]{figures/analytical/phioverQ-E1overE2-t2overt1}
    ...
    \begin{figure}[!htpb] %w_0,tip / Q versus L/B, flexural compliance
      \centering
      \includegraphics[width=0.8 \textwidth]{figures/analytical/woverQ-E1overE2-LoverB}
    ...
    \begin{figure}[!htpb] %\phi_tip / Q versus L/B, torsional compliance
      \centering
      \includegraphics[width=0.8 \textwidth]{figures/analytical/phioverQ-E1overE2-LoverB}
...
\section{Computational model analysis} \label{sec:computationalModelAnalysis_results_model}
  ...
  \subsection{Nonlinear problem and automatic stabilization} \label{subsec:nonlinear_results_model} %OK
    ...
    For the case under study, nonlinear simulations are carried out as is expected to find large displacement and non-constant stiffness. In ABAQUS$^{	extregistered}$, to execute nonlinear simulation involves the following considerations, as shown in \cite{Abaqus}:
    %
    \begin{itemize}
    ...
    Therefore, ABAQUS$^{	extregistered}$ breaks the step where the load is applied into increments. The software automatically chooses the size of each of the increments based on the convergence evolution of previous increments.
