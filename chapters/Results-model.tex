...
\section{Analytical model analysis} \label{sec:analyticalParametricStudy_results_model}
  ...
  \subsection{Bending and twisting coupling results} \label{subsec:bendingTwistCoupling_results_model}
  ...
  \clearpage
  \subsection{Parametric study results} \label{subsec:results_parametricStudy}
