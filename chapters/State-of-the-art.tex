...
\section{Compliant chiral structure} \label{sec:chiral_state}
  ...
  \begin{figure}[!htpb]
    \centering
    \subfigure[Flat ligaments.]{\label{fig:ramstein-flat}\includegraphics[width=0.4\textwidth]{figures/state-of-the-art/flat-ligaments}} \qquad
    \subfigure[Curved ligaments.]{\label{fig:ramstein-curved}\includegraphics[width=0.35\textwidth]{figures/state-of-the-art/curved-ligaments}}
