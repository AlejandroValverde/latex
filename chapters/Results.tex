...
\section{Results from the Abaqus CAE simulations} 

%The modeling of the lattice nodes through coupling through a reference point and through tyre provide with the same results. The two approaches were explained in Section \ref{subsec:parametrization_Model}.
