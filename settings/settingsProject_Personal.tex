...
%New commands
\newcommand{\chiB}{$B_{\mathrm{chiral}}$}
\newcommand{\chir}{$r_{\mathrm{chiral}}$}
\newcommand{\chiL}{$L_{\mathrm{chiral}}$}
\newcommand{\chit}{$t_{\mathrm{chiral}}$}
\newcommand{\boxt}{$t_{\mathrm{box}}$}
\newcommand{\chie}{$\epsilon_{\mathrm{chiral}}$}