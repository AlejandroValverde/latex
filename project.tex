...
\def\controlClearPage{paperCopy} %possible inputs: paperCopy, electronicCopy
...
\includeonly{chapters/Abstract, chapters/Acknowledgments, chapters/Model}%, chapters/Results-sim, chapters/Results-model, chapters/State-of-the-art} %{file1,file2,...}
