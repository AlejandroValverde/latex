...
%
% Compile doing:
% rm project.aux & rm chapters/*.aux & rm project.nlo & rm project.nls & pdflatex project && makeindex project.nlo -s nomencl.ist -o project.nls && bibtex project && pdflatex project && clear && pdflatex projec
